...
public:
    MenuItem(Sprite sprite, string name, SDL_Rect where );
    ...
    void setRectName( SDL_Rect Where ) {
        pRectName = Where;
    }
    void setRectDesc( SDL_Rect Where ) {
        pRectDesc = Where;
    }
    void setRectSprite( SDL_Rect Where ) {
        pRectSprite = Where;
    }
