...
cxx_addSprite( "PLAYER_RUN",      50,    100,    0,      120,    1,      200 ,      10,    true );
cxx_addSprite( "PLAYER_STAND",    50,    100,    548,    120,    1,      100 ,      1,    false );
cxx_addSprite( "PLAYER_FLY",      51,    110,    599,    120,    1,      60 ,       4,    true );
cxx_addSprite( "COUNTING",        50,    58,     0,      0,      1,      TIME_FACTOR*1000 ,      4,    false );
cxx_addSprite( "LIVE_BAR",        350,   428,    840,    20,     1,      620 ,      1,    false );
